...
/**
 * A checkout transaction at a station. The ID is assigned as {@code "tx-" + UUID}, and
 * the no-arg constructor initialises the OPEN state. {@code completedAt} appears only on
 * the receipt, not in the transaction response.
 */
@Entity
